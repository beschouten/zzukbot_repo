...
namespace something
{
    public class Schouten_FrostMage : CustomClass
    {
        ...
        //what is the frozen debuff from frost nova?
        ...
        public override void PreFight()
        {
            ...
            if (this.Target.DistanceToPlayer >= 15 && this.Player.CanUse("Arcane Missiles"))
            {
        ...
        {
            //if Atacker is frozen backup
            if(hasDebuff(this.Target, frozen) && this.Target.DistanceToPlayer < 6)
            {
                this.Player.ForceBackup(2);
                return;
            }
            ...
            if (this.Attackers.Count >= 2)
            {
                ...
                if (attackersAboutToDie() && this.Target.DistanceToPlayer < 10)
                {
                ...
                //cast frost nova
                if (this.Player.ManaPercent >= 20 && this.Player.GetSpellRank("Frost Nova") != 0 && this.Target.DistanceToPlayer <= 8 && this.Target.HealthPercent >= 20)
                {
                ...
                //mana shield
                if (this.Player.ManaPercent >= 65 && !this.Player.GotBuff("Mana Shield"))
                {
            ...
            //mana shield
            if (this.Player.ManaPercent >= 75 && !this.Player.GotBuff("Mana Shield"))
            {
                if (this.Player.GetSpellRank("Mana Shield") != 0)
                {
                    if (this.Player.CanUse("Mana Shield"))
            ...
            //cast frost nova
            if (this.Player.ManaPercent >= 10 && this.Player.GetSpellRank("Frost Nova") != 0 && this.Player.CanUse("Frost Nova") && this.Target.DistanceToPlayer <= 10 && this.Target.HealthPercent >= 20)
            {
                this.Player.Cast("Frost Nova");
                Player.ForceBackup(6);
                return;
            }
            //always fireblast
        ...
        public override bool Buff()
        {
            ...
            if (this.Player.GetSpellRank("Conjure Water") != 0)
            {
                ...
                {
                    this.Player.Cast(WaterName[this.Player.GetSpellRank("Conjure Water")]);
                    return false;
                }
            }
            ...
            if (this.Player.GetSpellRank("Conjure Food") != 0)
            {
                ...
                {
                    this.Player.Cast(FoodName[this.Player.GetSpellRank("Conjure Food")]);
                    return false;
                }
            }
